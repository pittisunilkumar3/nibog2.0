...
/**
 * Update privacy policy via API
 * @param policyText - The new privacy policy text
 * @returns Promise with the update result
 */
export async function updatePrivacyPolicy(policyText: string): Promise<any> {
    try {
        // Get auth token from localStorage or sessionStorage (same as footer service)
