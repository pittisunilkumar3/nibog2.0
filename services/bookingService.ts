...
export interface Booking {
  ...
  booking_date?: string; // Event booking date
  ...
  parent_name: string;
  parent_email: string;
  parent_phone?: string; // Parent phone number
  ...
  child_dob?: string; // Alias for child_date_of_birth (used in transformed data)
  child_school_name?: string;
  child_gender?: string;
  child_age?: string | number | null; // Add the new child_age field (optional since it might not be present in all responses)
  ...
  _original?: any; // Original nested API response
}
...
export async function getEventGameSlotDetailsBySlotId(slotId: number) {
  try {
    const response = await fetch('http://localhost:3004/api/event-game-slot/get', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export async function findMostLikelySlotForBooking(booking: any) {
  try {
    ...
    const slotsResponse = await fetch('http://localhost:3004/api/event-game-slot/get-all', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    ...
    const eventsResponse = await fetch('http://localhost:3004/api/event/get-all', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    ...
    const gamesResponse = await fetch('http://localhost:3004/api/baby-games/get-all', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
...
export async function getEventGameSlotDetails(eventId: number, gameId: number) {
  try {
    const response = await fetch('http://localhost:3004/api/event-game-slot/get-all', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    });
...
export async function getBookingPaymentDetails(bookingId: number) {
  try {
    const response = await fetch('http://localhost:3004/api/payments/get-all', {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    });
...
export async function getBookingAddons(bookingId: number): Promise<any> {
  try {
    ...
    const response = await fetch('http://localhost:3004/api/getting/add-on/by-bookingid', { 
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
